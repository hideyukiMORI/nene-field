...
/**
 * Maps {@see AttachmentStorageException} to a 500 problem+json response,
 * replacing the previous per-handler try/catch block. The storage path is
 * never exposed (NF7).
 */
final readonly class AttachmentStorageExceptionHandler implements DomainExceptionHandlerInterface
{
    ...
    {
        return $exception instanceof AttachmentStorageException;
    }
