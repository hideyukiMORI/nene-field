 ...
 *
 * `GET /organizations` is bearer-protected but bypasses org resolution, so these
 * assertions isolate the credential-restoration behaviour with no seeded tenant.
 *
...
{
    private const PROTECTED_PATH = '/organizations';
     ...
     * challenge; its absence proves authentication succeeded (any further 401 here
     * is downstream authorization — the org list handler requiring a role claim —
     * which is out of scope for the transport-level mirror proof).
     */
